...
from src.enum import userCommand, modelResult, wallEState
...
def globalUpdate():
    ...
    globals().update(modelResult.__members__)
...
if __name__ == '__main__':
    ...
    # Sharing State
    userControl = Value('i', NONE) # user command
    ...
    stateProcess = Process(target=stateManager, args=(userControl, modelResult))
    # Start the processes
    userProcess.start()
    modelProcess.start()
